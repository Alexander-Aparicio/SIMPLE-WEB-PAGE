...
import { P } from "./estilosGenerales";
import { Article, TitleH1, TitleH2 } from "../Home/HomeStyles";
...
const Diapositiva2 = styled(Article)`
    height:100%;
    padding:10px;
    padding-top:100px;
    padding-left:24px;
...
export { MainBox , Diapositiva, MainTitleD, TitleD, ContenidoD, MySlide, CtaButton, BoxCta, Diapositiva2, MainBox2}
